...
public class AdminWithdrawalDispatcher implements Dispatcher {
    ...
    public DispatchResult dispatch(HttpServletRequest request, String page) {
        ...
        BigDecimal lockAmount = adminAccount.getLockAmount().divide(new BigDecimal("100"),4,BigDecimal.ROUND_HALF_UP);
        BigDecimal paidAmount = adminAccount.getPaidAmount().divide(new BigDecimal("100"),4,BigDecimal.ROUND_HALF_UP);
