...
import com.hfb.merchant.code.util.ParamUtil;
 ...
 * @date 2015-12-9
 */
public class PayNotCardNotifyServlet extends HttpServlet{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(PayNotCardNotifyServlet.class);
